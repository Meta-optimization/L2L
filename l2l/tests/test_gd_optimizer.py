...
class GDOptimizerTestCase(OptimizerTestCase):
    ...
    def test_gd(self):
        optimizer_parameters = RMSPropParameters(
            learning_rate=0.01,
        ...
        try:
            ...
            self.experiment_functionGenerator.run_experiment(
        ...
        best = list_to_dict(
            self.experiment_functionGenerator.optimizer.current_individual.tolist(),
            self.experiment_functionGenerator.optimizer.optimizee_individual_dict_spec,
        )["coords"]
        ...
        try:
            ...
            self.experiment_activeWait.run_experiment(
        ...
        best = list_to_dict(
            self.experiment_activeWait.optimizer.current_individual.tolist(),
            self.experiment_activeWait.optimizer.optimizee_individual_dict_spec,
        )["difficulty"]
