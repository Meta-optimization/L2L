...
def run_experiment():
    ...
    optimizee_parameters = MNISTOptimizeeParameters(
        n_hidden=10, seed=optimizee_seed, use_small_mnist=True
    )
    # Innerloop simulator
    ...
    optimizer_parameters = CrossEntropyParameters(
        ...
        temp_decay=0,
        n_iteration=5000,
        distribution=NoisyGaussian(noise_magnitude=1.0, noise_decay=0.99),
