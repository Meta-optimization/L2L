...
class MultiGradientDescentOptimizer(Optimizer):
    ...
    def __init__(self, traj,
        ...
        new_individual_list.append(list_to_dict(self.current_individual, self.optimizee_individual_dict_spec)) # TODO
    ...
    def post_process(self, traj, fitnesses_results):
        ...
        logger.info(f'old_eval {old_eval_pop}')
        logger.info(f'fit {fitness_sorting_indices}')
        logger.info(f'old as array {old_eval_pop_as_array.shape}')
