...
from l2l.tests import test_checkpoint_ce
from l2l.tests import test_checkpoint_sa
...
def test_suite():
    ...
    suite.addTest(test_checkpoint_ce.suite())
    suite.addTest(test_checkpoint_sa.suite())
