...
const float g = 0.2;
//float P_e[] = {-0.0498, 0.00506, -0.025, 0.0014, -0.00041, 0.0105, -0.036, 0.0074, 0.0012, -0.0407};
//float P_i[] = {-0.0514, 0.004, -0.0083, 0.0002, -0.0005, 0.0014, -0.0146, 0.0045, 0.0028, -0.0153};
...
//        state(i_step%nh, i_node + 7 * n_node) = 0.0f;
//        tavg(i_node) = 0.0f;
        if (i_step == 0){
    ...
    //***// This is the loop over nodes, which also should stay the same
        ...
        {
//            get the value for each region
//            float tau_i = alpha_g*gaba_ratio[i_node]+beta_g;
//            float E_L_i = gamma_g*gaba_ratio[i_node]+delta_g;
...
//            if (t==i_step+1) printf("noisebuf %f\n", noise);
...
//            printf("_diff2_fi_fi_i %f \n", _diff2_fi_fi_i);

//            _diff_fe_TF_e = _diff_fe(TF_excitatory, E, I, E_input_excitatory, I_input_excitatory, W_e);
//            _diff_fe_TF_i = _diff_fe(TF_inhibitory, E, I, E_input_inhibitory, I_input_inhibitory, W_i);
//            _diff_fi_TF_e = _diff_fi(TF_excitatory, E, I, E_input_excitatory, I_input_excitatory, W_e);
//            _diff_fi_TF_i = _diff_fi(TF_inhibitory, E, I, E_input_inhibitory, I_input_inhibitory, W_i);

//            _diff_fe_TF_e = _diff_fe_e;
//            _diff_fe_TF_i = _diff_fe_i;
//            _diff_fi_TF_e = _diff_fi_e;
//            _diff_fi_TF_i = _diff_fi_i;
